          ...
          <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
               ...
               <div>
                <div className='lg:w-[570px]'>
                    ...
                    <p className='text_para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque quasi et molestiae quae nihil laudantium rerum officiis deserunt veritatis quis temporibus praesentium ab sequi ex dolores ea itaque, incidunt libero esse tempora fugit saepe. Harum voluptatum ea dolore numquam libero?</p>
                    
                    <Link to='/find-a-doctor'><button className="btn">Request an Appointment</button></Link>
                </div>
                {/* ======== hero counter ======*/}
