...
const Signup = () => {
    ...
    const handleFileInputChange = async (e) => {
        ...
        //later we will use the Cloudinary to upload images
    }
                    ...
                    <div className='rounded-l-lg lg:pl-16 py-10'>
                        ...
                        <form onSubmit={submitHandler}>
                            ...
                            <div className='mb-5 flex items-center justify-between'>
                                <label className='text-headingColor font-bold text-[16px]leading-7'>Are you a: <select name="role" id="" value={formData.role} onChange={handleInputChange} className='text-textColor font-semibold text-[15px] leading-7 px-4 py-0 focus:outline-none'>
                                    <option value="patient">Patient</option>
                                    <option value="doctor">Doctor</option>
                                </select></label>

                                <label className='text-headingColor font-bold text-[16px]leading-7'>Gender: <select name="gender" id="" value={formData.gender} onChange={handleInputChange}className='text-textColor font-semibold text-[15px] leading-7 px-4 py-0 focus:outline-none'>
                            ...
                            <div className='mb-5 flex items-center gap-3'>
                                { loading ? <div className='flex justify-center items-center'><Loader/></div> :  <figure className='w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center'>
                                    <img src={selectedFile != null ? selectedFile : avatar} alt="" className='w-full rounded-full h-full' />
                                </figure>}
                            ...
                            <div className='mt-7'>
                                { loading ? <div className='flex justify-center items-center h-[40px]'><Loader/></div> :  <button type='submit' className='w-full bg-primaryColor text-white text-[20px] leading-[30px] rounded-lg px-4 py-2'>Signup</button>}
                            </div>
